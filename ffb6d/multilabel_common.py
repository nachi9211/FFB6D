...
class ConfigRandLA:
    ...
    num_classes = 15+1  # Number of valid classes
    sub_grid_size = 0.06  # preprocess_parameter

    batch_size = 1  # Nachi batch_size during training
    val_batch_size = 1  # Nachi batch_size during validation and test
...
class Config:
    def __init__(self, ds_name='ycb', cls_type=''):
        ...
        self.n_total_epoch = 20 #Nachi was 25
